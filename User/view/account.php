            ...
            <div class="c-account-profile">
                <div class="account-managed c-manage">
                    <div class="inner-account">
                        <img src="/watcher/assets/mwala-07.jpg" alt="account image" class="circle-img inner-img c-img" onclick="updateImg()">
                    </div>
                    <div>
        ...
        <div class="c-account">
            <form action="" method="post" class="c-container">
                <div class="c-part">
                    ...
                    <div class="c-btn">
                        <a href="/watcher/User/forms/usersettings.php"><span>Edit</span></a>
                    </div>
                </div>
                <div class="c-part">
                    <div class="c-field">
                    ...
                    <div class="c-btn">
                        <a href="/watcher/User/forms/usersettings.php"><span>Change</span></a>
                    </div>
                </div>
            </form>
            <div class="c-footer">
