...
<div class="chat-section">
    <div class="show-chat-section">
        ...
        <div class="chat-container">
            <!-- chat loop -->
            <?php foreach($chat as $ch) $_SESSION['chatname'] = $ch->username;  { ?>
            <div class="chat-profile profile-universal" onclick="getMessage()">
                <img src="/watcher/assets/mwala-05.jpg" alt="chat profile" class="circle-img chat-image">
                <div class="chat-profile-info">
                    <div class="onactive-chat">
                        <?php echo "<h1>$ch->username</h1>";?>
                    ...
                    <span>12:00pm</span>
                    <?php echo "<span>$ch->account_type</span>";?>
                </div>
            </div>
            <?php }?>
            <!-- \end of chat loop -->
