...
$type = $_SESSION["user_acc"];
$port = "3000";
//chat api endpoint
$chat_url = "http://127.0.0.1:${port}/api/form/chat_sender/read.php";
$report_url = "http://127.0.0.1:${port}/api/form/report/read.php";
$complain_url = "http://127.0.0.1:${port}/api/form/complain/read.php";
...
<body>
    <div class="dashboard-panel">
        ...
        <div class="dashboard-nav">
            ...
            <div class="profile">
                <img src="/watcher/assets/mwala-07.jpg" alt="image" class="profile-img circle-img">
                ...
                <div class="outer-dash">
                    ...
                    <div class="inner-dash chief-inner-dash">
                        <div class="inner-info chief-inner-info">
                            ...
                            <div class="profile">
                                <img src="/watcher/assets/mwala-08.jpg" alt="image" class="profile-img p-img circle-img">
