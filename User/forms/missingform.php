...
<body>
    ...
    <form action="/watcher/include/missingform.inc.php" method="post" class="f-c-p">
        <div class="p-f-details">
            <div class="p-input">
            <label for="firstname">first name</label>
            <input required type="text" class="f-input" name="first_name" placeholder="omondi" id="firstname">
            </div>
            <div class="p-input">
            <label for="lastname">last name</label>
            <input required type="text" class="f-input" name="last_name" placeholder="jalang" id="lastname">
            </div>
            <div class="p-input">
