...
<body>
    <div class="form-container">
        <form action="/watcher/include/chiefform.inc.php" method="post" class="f-c-p">
        ...
        <div class="p-f-details">
            ...
            <input required type="date" class="f-input" placeholder="yyyy/mm/dd" name="date_of_birth" id="birth">
            </div>
            <div class="p-input">
            ...
            <input required type="number" class="f-input" placeholder="073454353" name="phone_no" id="phone">
            </div>
            <div class="p-input">
            <label for="service">Service no</label>
            <input required type="number" class="f-input" placeholder="3254355" name="service_no" id="service">
            </div>
            <div class="p-input">
            <label for="location">Location</label>
            <input required type="text" class="f-input" placeholder="laikipia" name="location" id="service">
            </div>
            <div class="p-input">
            <label for="rank">Rank</label>
            <input required type="text" class="f-input" placeholder="Ass Chief" name="rank" id="rank">
            </div>
            <div class="p-input">
            ...
            <input required type="text" class="a-input" placeholder="about yourself" name="about" id="about">
            </div>
        </div>
           <div class="p-btn">
        <a href="/watcher/Chief/Authentication/chiefsignin.php"><button class="btn-p btn-cancel">Cancel</button></a>
