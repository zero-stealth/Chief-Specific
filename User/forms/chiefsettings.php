...
<body>
    <div class="form-container">
        <form action="/watcher/include/chiefaccountupdate.php" method="post" class="f-c-p">
            ...
            <div class="p-f-details">
                ...
                <div class="p-input">
                    ...
                    <input required type="password" class="f-input" placeholder="*********" name="password" id="password">
                </div>
            <div class="p-btn">
                <a href="/watcher/Chief/chiefpanel.php"><button class="btn-p btn-cancel">Cancel</button></a>
