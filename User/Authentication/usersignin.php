...
<body>
    ...
    <div class="login-section">
        ...
        <div class="login-image-container">
            <img src="/watcher/assets/mwala-09.jpg" alt="image on log in" class="login-image">
            </div>
            <!-- login container -->
            <div class="login-container">
                <div class="login-info">
                    <h1>Signin </h1>
                        <form action="/watcher/include/usersignin.inc.php" method="post" class="form-container">
                        ...
                        <a href="./userlogin.php" class="link">Already have an account?<span>Log in </span></a>
                        </form>
                </div>
            </div>
    </div>
