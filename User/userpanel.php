    ...
    <div class="panel">
        ...
        <script>
            $('#home-nav').click(function() {
                $('#side-bar').toggleClass('visible slide-right');
            });
        </script>
...
" id="image10" />
            ...
            <div class="navbar-contained">
                ...
                <div class="sidebar-nav-items">
                    ...
                    <a href="#" class="sidebar-link" id="report">
                        <svg class="icon icon-report" viewBox="0 0 17.999998 17.999998" fill="none" version="1.1" id="svg186" sodipodi:docname="report.svg" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg">
                            <sodipodi:namedview id="namedview188" pagecolor="#ffffff" bordercolor="#000000" borderopacity="0.25" inkscape:showpageshadow="2" inkscape:pageopacity="0.0" inkscape:pagecheckerboard="0" inkscape:deskcolor="#d1d1d1" showgrid="false" />
                            <g clip-path="url(#clip0_13_197)" id="g140" transform="translate(-42.868981,-348.92961)">
                                <path d="m 44.868981,362.92961 c -0.55,0 -1.021,-0.196 -1.413,-0.587 -0.3913,-0.392 -0.587,-0.863 -0.587,-1.413 v -6 c 0,-0.55 0.1957,-1.021 0.587,-1.413 0.392,-0.391 0.863,-0.587 1.413,-0.587 h 14 c 0.55,0 1.021,0.196 1.413,0.587 0.3913,0.392 0.587,0.863 0.587,1.413 v 6 c 0,0.55 -0.1957,1.021 -0.587,1.413 -0.392,0.391 -0.863,0.587 -1.413,0.587 z m -2,-12 v -2 h 18 v 2 z m 0,16 v -2 h 18 v 2 z" fill="#a3a5a4" id="path26" inkscape:export-filename="path27.svg" inkscape:export-xdpi="96" inkscape:export-ydpi="96" />
                                <path d="m 45.5,930 c 0,-0.199 0.079,-0.39 0.2197,-0.53 0.1406,-0.141 0.3314,-0.22 0.5303,-0.22 H 53 v -4.875 c 0,-1.5 -1.5839,-2.625 -3,-2.625 h -7.125 c -0.696,10e-4 -1.3632,0.278 -1.8553,0.77 -0.4922,0.492 -0.769,1.159 -0.7697,1.855 v 11.25 c 7e-4,0.696 0.2775,1.363 0.7697,1.855 0.4921,0.492 1.1593,0.769 1.8553,0.77 h 7.5 c 0.696,-10e-4 1.3632,-0.278 1.8553,-0.77 0.4922,-0.492 0.769,-1.159 0.7697,-1.855 v -4.875 h -6.75 c -0.1989,0 -0.3897,-0.079 -0.5303,-0.22 C 45.579,930.39 45.5,930.199 45.5,930 Z m 14.0302,-0.53 -3.75,-3.75 c -0.1418,-0.135 -0.3307,-0.209 -0.5262,-0.206 -0.1956,0.002 -0.3825,0.081 -0.5208,0.219 -0.1383,0.139 -0.2171,0.325 -0.2196,0.521 -0.0025,0.196 0.0715,0.384 0.2062,0.526 l 2.4694,2.47 H 53 v 1.5 h 4.1892 l -2.4694,2.47 c -0.0725,0.069 -0.1306,0.152 -0.1706,0.243 -0.0401,0.092 -0.0614,0.191 -0.0627,0.291 -0.0013,0.1 0.0175,0.199 0.0552,0.292 0.0377,0.093 0.0936,0.177 0.1644,0.248 0.0708,0.071 0.155,0.127 0.2478,0.164 0.0927,0.038 0.192,0.057 0.2921,0.056 0.1001,-0.002 0.199,-0.023 0.2907,-0.063 0.0917,-0.04 0.1745,-0.098 0.2435,-0.171 l 3.75,-3.75 c 0.1405,-0.14 0.2195,-0.331 0.2195,-0.53 0,-0.199 -0.079,-0.39 -0.2195,-0.53 z" fill="#a3a5a4" id="path28" />
.491 0.624,0.869 1.072,1.136 0.448,0.256 0.944,0.384 1.4884,0.384 0.544,0 1.04,-0.128 1.488,-0.384 0.458,-0.267 0.821,-0.645 1.088,-1.136 0.266,-0.501 0.4,-1.083 0.4,-1.744 z m 12.022,4.544 c -0.822,0 -1.568,-0.187 -2.24,-0.56 -0.662,-0.373 -1.184,-0.901 -1.568,-1.584 -0.374,-0.693 -0.56,-1.493 -0.56,-2.4 0,-0.896 0.192,-1.685 0.576,-2.368 0.394,-0.693 0.928,-1.221 1.6,-1.584 0.672,-0.373 1.424,-0.56 2.256,-0.56 0.832,0 1.584,0.187 2.256,0.56 0.672,0.363 1.2,0.885 1.584,1.568 0.394,0.683 0.592,1.477 0.592,2.384 0,0.907 -0.203,1.707 -0.608,2.4 -0.395,0.683 -0.934,1.211 -1.616,1.584 -0.683,0.373 -1.44,0.56 -2.272,0.56 z m 0,-1.28 c 0.522,0 1.013,-0.123 1.472,-0.368 0.458,-0.245 0.826,-0.613 1.104,-1.104 0.288,-0.491 0.432,-1.088 0.432,-1.792 0,-0.704 -0.139,-1.301 -0.416,-1.792 -0.278,-0.491 -0.64,-0.853 -1.088,-1.088 -0.448,-0.245 -0.934,-0.368 -1.456,-0.368 -0.534,0 -1.024,0.123 -1.472,0.368 -0.438,0.235 -0.79,0.597 -1.056,1.088 -0.267,0.491 -0.4,1.088 -0.4,1.792 0,0.715 0.128,1.317 0.384,1.808 0.266,0.491 0.618,0.859 1.056,1.104 0.437,0.235 0.917,0.352 1.44,0.352 z m 14.186,-7.632 V 936 h -1.456 v -1.296 c -0.277,0.448 -0.667,0.8 -1.168,1.056 -0.491,0.245 -1.035,0.368 -1.632,0.368 -0.683,0 -1.296,-0.139 -1.84,-0.416 -0.544,-0.288 -0.976,-0.715 -1.296,-1.28 -0.309,-0.565 -0.464,-1.253 -0.464,-2.064 v -5.136 h 1.44 v 4.944 c 0,0.864 0.219,1.531 0.656,2 0.437,0.459 1.035,0.688 1.792,0.688 0.779,0 1.392,-0.24 1.84,-0.72 0.448,-0.48 0.672,-1.179 0.672,-2.096 v -4.816 z m 4.235,1.2 v 5.168 c 0,0.427 0.09,0.731 0.272,0.912 0.181,0.171 0.496,0.256 0.943,0.256 h 1.073 V 936 h -1.312 c -0.811,0 -1.419,-0.187 -1.824,-0.56 -0.406,-0.373 -0.608,-0.987 -0.608,-1.84 v -5.168 h -1.136 v -1.2 h 1.136 v -2.208 h 1.456 v 2.208 h 2.288 v 1.2 z" fill="#a3a5a4" id="path30" />
                            </g>
                            <defs id="defs184">
                                <clipPath id="clip0_13_197">
                                    <rect width="1512" height="982" rx="20" fill="#ffffff" id="rect176" x="0" y="0" />
                                </clipPath>
                            </defs>
                        </svg>
        ...
        <div class="main-section">
            ...
            <script>
                ...
                //page
                var reportPage = "./view/reportManagement.php";
                ...
                $(report).click(function() {
                    $(mainSection).load(reportPage);
                    $(account).removeClass(activeLink);
                    $(chatMng).removeClass(activeLink);
                    $(dashboard).removeClass(activeLink);
                    $(search).removeClass(activeLink);
                    $(report).addClass(activeLink);
