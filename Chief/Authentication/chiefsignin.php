...
<body>
    ...
    <div class="login-section">
        ...
        <div class="login-image-container">
            <img src="/watcher/assets/mwala-03.jpg" alt="image on log in" class="login-image">
        </div>
        <!-- login container -->
        <div class="login-container">
            <div class="login-info">
                <h1>Signin </h1>
                <form action="/watcher/include/chiefsignin.inc.php" method="post" class="form-container">
