...
<body>
    ...
    <div class="login-section">
        ...
        <div class="login-image-container">
            <img src="/watcher/assets/mwala-01.jpg" alt="image on log in" class="login-image">
        </div>
        <!-- login container -->
        <div class="login-container">
            <div class="login-info">
                <h1>Login </h1>
                <form action="/watcher/include/chieflogin.inc.php" method="post" class="form-container">
